...
def main():
    ...
    BlindSet = datacontrol.readFile("../data/ML-CUP18-TS.csv", shuff=False)
    X, Y = datacontrol.divide(TrainingData)
    scaler = StandardScaler()
    start = time.time()
    NN = kerasNN.KerasNN(NetworArchitecture = [625, 625, 625, 625, 625], activation = "relu", eta = 0.00015, momentum = 0.99, epochs = 6000, DropOutHiddenLayer = 0.2)
